...
#ifndef _NPY_SIMD_LASX_LASX_H
#define _NPY_SIMD_LASX_LASX_H
...
// LASX implies LSX; some helpers may want LSX intrinsics for the
// "narrow into a 128-bit half" code paths in math.h / reorder.h.
#include <lsxintrin.h>
