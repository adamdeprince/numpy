...
#define npyv_and_f32(A, B)  (__m256)__lasx_xvand_v((__m256i)A, (__m256i)B)
#define npyv_and_f64(A, B)  (__m256d)__lasx_xvand_v((__m256i)A, (__m256i)B)
...
#define npyv_or_f32(A, B)   (__m256)__lasx_xvor_v((__m256i)A, (__m256i)B)
#define npyv_or_f64(A, B)   (__m256d)__lasx_xvor_v((__m256i)A, (__m256i)B)
...
#define npyv_xor_f32(A, B)   (__m256)__lasx_xvxor_v((__m256i)A, (__m256i)B)
#define npyv_xor_f64(A, B)   (__m256d)__lasx_xvxor_v((__m256i)A, (__m256i)B)
...
// check special cases (non-signaling unordered compare: a==a iff not-NaN)
NPY_FINLINE npyv_b32 npyv_notnan_f32(npyv_f32 a)
{ return __lasx_xvfcmp_cor_s(a, a); }
NPY_FINLINE npyv_b64 npyv_notnan_f64(npyv_f64 a)
{ return __lasx_xvfcmp_cor_d(a, a); }

// Reduce a 256-bit byte-mask vector to a 32-bit scalar mask.
// xvmsknz_b stores a 16-bit byte-nonzero mask in the low 16 bits of each
// 128-bit half. LASX lacks xvpickve2gr_hu, so read the enclosing 32-bit lane
// (word 0 for the low half, word 4 for the high half) and mask off the low
// 16 bits.
NPY_FINLINE npy_uint32 npyv__msknz_b_lasx(__m256i a)
{
...
#define NPYV_IMPL_LASX_ANYALL(SFX)                  \
    ...
    { return npyv__msknz_b_lasx((__m256i)a) != 0; } \
    NPY_FINLINE bool npyv_all_##SFX(npyv_##SFX a)   \
    { return npyv__msknz_b_lasx((__m256i)a) == 0xFFFFFFFFu; }
...
#define NPYV_IMPL_LASX_ANYALL(SFX, TSFX)                                          \
    NPY_FINLINE bool npyv_any_##SFX(npyv_##SFX a)                                 \
    { return npyv__msknz_b_lasx(a) != 0; }                                        \
    NPY_FINLINE bool npyv_all_##SFX(npyv_##SFX a)                                 \
    { return npyv__msknz_b_lasx(__lasx_xvseq_##TSFX(a, npyv_zero_##SFX())) == 0; }
NPYV_IMPL_LASX_ANYALL(u8,  b)
NPYV_IMPL_LASX_ANYALL(s8,  b)
NPYV_IMPL_LASX_ANYALL(u16, h)
NPYV_IMPL_LASX_ANYALL(s16, h)
NPYV_IMPL_LASX_ANYALL(u32, w)
NPYV_IMPL_LASX_ANYALL(s32, w)
NPYV_IMPL_LASX_ANYALL(u64, d)
NPYV_IMPL_LASX_ANYALL(s64, d)
#undef NPYV_IMPL_LASX_ANYALL

NPY_FINLINE bool npyv_any_f32(npyv_f32 a)
{ return npyv__msknz_b_lasx(__lasx_xvfcmp_ceq_s(a, npyv_zero_f32())) != 0xFFFFFFFFu; }
NPY_FINLINE bool npyv_all_f32(npyv_f32 a)
{ return npyv__msknz_b_lasx(__lasx_xvfcmp_ceq_s(a, npyv_zero_f32())) == 0; }
NPY_FINLINE bool npyv_any_f64(npyv_f64 a)
{ return npyv__msknz_b_lasx(__lasx_xvfcmp_ceq_d(a, npyv_zero_f64())) != 0xFFFFFFFFu; }
NPY_FINLINE bool npyv_all_f64(npyv_f64 a)
{ return npyv__msknz_b_lasx(__lasx_xvfcmp_ceq_d(a, npyv_zero_f64())) == 0; }
